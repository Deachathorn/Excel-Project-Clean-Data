...
### 📄 **Column Blank Value Delete**

![Column Blank Value](./assets/Column%20Blank.png)

เนื่องจาก `Column` เป็น `Blank Column` จึงไม่มีประโยชน์ที่จะต้องเก็บไว้เช่นเดียวกับ `Blank Row` เพราะถือว่าเป็น ข้อมูลที่ไม่มีค่า หรือ ไม่สมบูรณ์ ไม่ก่อให้เกิดประโยชน์ถ้าเกิดนำข้อมูลไปวิเคราะห์ต่อ
...
### 📄 **Insert Correct Data in Duration Column**
